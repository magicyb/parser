...
public interface Antlr4PilarVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link Antlr4PilarParser#NewMultiSeqFragmentEExp}.
	...
	/**
	 * Visit a parse tree produced by {@link Antlr4PilarParser#BlockTransformation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link Antlr4PilarParser#MultilineStringConstant}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link Antlr4PilarParser#NewMultiSeqFragmentENew}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link Antlr4PilarParser#StaticMultiSeqFragment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
